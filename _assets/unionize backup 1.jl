...
md"""
As no further information is available, this becomes a `Vector{Any}`:
"""
...
md"""
We can define a union of the possible function types and thus constrain the the number of possible function types occuring during the element access:
"""
...
md"""
As shown above, union splitting is a highly useful and relatively easy to use concept to avoid daynamic dispatch overhead in many cases.
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "9321d3e3f55e3084ae5d985df3a8896c65ab5ac9"
