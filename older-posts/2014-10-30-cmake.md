...
- [Documentation (v3.0)](http://www.cmake.org/cmake/help/v3.0/)
- [Tutorial (cmake home page)](http://www.cmake.org/cmake-tutorial/)
- [Tutorials (as found by Google)](https://www.google.de/search?q=cmake+tutorial)
- [CMake basics for busy scientists (Radovan Bast)](http://rbast.github.io/talks/cmake/basics)
...
[tinyproject.zip](blobs/tinyproject.zip)
...
Just for demonstration, we perform a build with ninja.  Ninja
is much faster than make, and it can work efficiently in parallel.
So it makes a difference in large projects.
However it currently does not work for projects containing Fortran code.
